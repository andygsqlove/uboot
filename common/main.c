...
void using_sdfuse(void)
{
	...
	while(1)
	{
		...
		switch(select) 
		{
			...
			case '2':
				ExecuteCmd("sdfuse flash uboot u-boot.bin");
				break;
			...
			case '5':
				ExecuteCmd("sdfuse flash system gec210.img");
				break;
			...
			case '7':
				...
				break;
			case '9':
				ExecuteCmd("sdfuse flash gec210.ini");
			case '8':
				return;
