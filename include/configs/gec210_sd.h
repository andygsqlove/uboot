...
#define DMC0_TIMINGA_REF        0x00000516      // TimingAref   7.8us*133MHz=1038(0x40E), 100MHz=780(0x30C), 20MHz=156(0x9C), 10MHz=78(0x4E)
//#define DMC0_TIMING_ROW         0x2B34438A      // TimingRow    for @200MHz
#define DMC0_TIMING_ROW         0x282332C8      // TimingRow    for @200MHz
...
#define DMC1_TIMINGA_REF        0x00000516      // TimingAref   7.8us*133MHz=1038(0x40E), 100MHz=780(0x30C), 20MHz=156(0x9C), 10MHz=78(0x4E)
#define DMC1_TIMING_ROW         0x282332C8      // TimingRow    for @200MHz
...
#define CONFIG_IDENT_STRING	" for GEC210"
