	...
	if (ext_csd_struct >= 2) {
		...
		if (host->ext_csd.sectors)
		{
			...
			//common host->read_bl_len=512
                        host->capacity = (host->ext_csd.sectors*512)/host->read_bl_len;
		}
	}
...
//yan
	...
	case EXT_CSD_CARD_TYPE_52 | EXT_CSD_CARD_TYPE_26:
		host->ext_csd.hs_max_dtr = 26000000;//52000000;
		host->clock = 26000000;//52000000;
		host->ext_csd.hs_max_dtr = 52000000;
		host->clock = 52000000;
		break;
	case EXT_CSD_CARD_TYPE_26:
